/**
 * ADR-0005: the sole sanctioned insert of correlation_findings for detection
 * materialization. Finality is enforced intrinsically via FinalizedEventProof —
 * not solely by caller ordering.
 */
